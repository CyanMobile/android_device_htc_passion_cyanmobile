package com.Passion.PassionUpdater;
...
public class PassionUpdaterActivity extends Activity {
	private static TextView textView;
	private static TextView buttonTextView;
	private static final String manifestURL = "https://raw.github.com/TaichiN/Passion-ROM/gingerbread/README";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		buttonTextView = (TextView) findViewById(R.id.PassionUpdaterButton);
	...
	public void myClickHandler(View view) {
		textView.setGravity(17);
		switch (view.getId()) {
		case R.id.PassionUpdaterButton:
			try {
				...
				if (data != null) {
					...
					if (fileUri != null && !fileUri.toString().equals("")) {
						...
						if (filePath != null) {
							...
							try {
								checkDownloadedMD5.setAction(com.Passion.PassionUpdater.PassionUpdaterActivity.checkMD5(filePath, true));
							} catch (IOException e) {
								// TODO Auto-generated catch block
								checkDownloadedMD5.setAction(com.Passion.PassionUpdater.PassionUpdaterActivity.badFilePath());
							}
